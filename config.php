...
define('OPENAI_API_KEY', 'YOURKEYGOESHERE'); 
// Define the model to be used.
define('MODEL', 'gpt-4o'); // This is a hypothetical model name for GPT-4, refer to the OpenAI documentation for the correct model ID
